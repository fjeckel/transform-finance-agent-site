...
import { LinkedinIcon, Youtube } from 'lucide-react';
const DynamicSocialHandlesSection = () => {
  // For now using hardcoded links, but this could be made dynamic
  // by creating a social_links table or storing in site configuration
  const socialLinks = [{
    name: 'LinkedIn',
  ...
  return <section id="social" className="py-20 bg-gradient-to-br from-gray-900 to-black">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">Werdet Teil der Community!</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {socialLinks.map((social, index) => <a key={index} href={social.url} target="_blank" rel="noopener noreferrer" className="group relative overflow-hidden rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 p-6 hover:bg-white/20 transition-all duration-300 hover:scale-105">
